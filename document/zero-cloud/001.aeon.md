...
&ensp;&ensp;&ensp;&ensp;当然您依旧可以采用crio作为学习过程中的运行时时候，在K8S学习时是无关CRI这一层的，这一点倒是比较友好，只是从生产环境考虑，还是使用cri-dockerd比较稳妥，虽然没了`dockershim`，但有替代品也是可以的。

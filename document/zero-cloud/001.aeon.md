...
&ensp;&ensp;&ensp;&ensp;systemd是**新一代的init系统**，其主要特点是并发处理所有服务，加速开机流程。
...
> Docker到K8S的转变以及容器技术的发展无法绕开cgroups和systemd两个角色，我不打算在这里讲解这两个角色的方方面，只是浅尝辄止，保证您可以在遇到环境配置问题时变得不那么困惑。

...
3. 最终安装地址：`/usr/lib/jvm/java-11-openjdk-amd64`，该地址对`JAVA_HOME`设置有帮助，后边环境变量部分会使用到。

### 2.1.2. ZuLu JDK 11（推荐配置）

* 下载地址：<https://cdn.azul.com/zulu/bin/zulu11.54.25-ca-jdk11.0.14.1-linux_amd64.deb>

1. 使用`wget`命令下载ZuLu安装包：

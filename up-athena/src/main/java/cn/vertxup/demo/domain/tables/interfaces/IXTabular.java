...
*/
package cn.vertxup.demo.domain.tables.interfaces;
...
public interface IXTabular extends Serializable {
     ...
     */
    public void from(cn.vertxup.demo.domain.tables.interfaces.IXTabular from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IXTabular
     */
    public <E extends cn.vertxup.demo.domain.tables.interfaces.IXTabular> E into(E into);

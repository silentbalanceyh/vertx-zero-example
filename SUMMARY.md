...
* [2. 氷る世界（Ψυχρός κόσμος）](/document/zero-cloud/000.index.md)
    * [2.1.贪婪岛：Aeon（K8S 1.25 + CRI-O）](/document/zero-cloud/001.aeon.md)
    * [2.2.盖亚：Ceph](/document/zero-cloud/002.ceph.md)
    * [2.3.零步进：Harbor](/document/zero-cloud/003.harbor.md)
    * [2.4.执子之手：Ceph RBD](/document/zero-cloud/004.rbd.md)